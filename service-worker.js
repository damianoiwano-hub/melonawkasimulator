...
self.addEventListener('fetch',e=>{
  ...
  const isApp=u.pathname.endsWith('/')||/index\.html$|app-v73\.js$|melon-economy-v74\.js$|discord-nav-v75\.js$|users-live-v751\.js$|styles-v7\.css$|discord-v74\.css$|discord-nav-v75\.css$/.test(u.pathname);
  if(isApp){
